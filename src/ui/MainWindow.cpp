...
namespace GnotePad::ui
{
    ...
    void MainWindow::handleSetTabSize()
    {
        ...
        const int newSize = QInputDialog::getInt(
            this, tr("Tab Size"), tr("Spaces per tab:"), currentSize, MinTabSizeSpaces, MaxTabSizeSpaces, TabSizeStep, &accepted);
